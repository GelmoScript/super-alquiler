...
@BORRADO BIT = 0
AS
INSERT INTO VEHICULOS VALUES (@MARCA,@MODELO,@AÑOS,@COLOR,@PRECIO_POR_DIA,@TIPO,@CAPACIDAD_DE_CARGA,@PASAJEROS,@MATRICULA,@NUMERO_DE_SEGURO,@FOTO,@LATITUD,@LONGITUD,@ESTATUS,@BORRADO)
...
@BORRADO BIT
AS
UPDATE VEHICULOS SET MARCA=@MARCA,MODELO=@MODELO,AÑOS=@AÑOS,COLOR=@COLOR,PRECIO_POR_DIA=@PRECIO_POR_DIA,TIPO=@TIPO,CAPACIDAD_DE_CARGA=@CAPACIDAD_DE_CARGA,PASAJEROS=@PASAJEROS,MATRICULA=@MATRICULA,NUMERO_DE_SEGURO=@NUMERO_DE_SEGURO,FOTO=@FOTO,LATITUD=@LATITUD,LONGITUD=@LONGITUD,ESTATUS=@ESTATUS, BORRADO=@BORRADO WHERE ID_VEHICULO=@ID_VEHICULO
