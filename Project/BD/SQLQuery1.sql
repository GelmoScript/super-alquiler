...
SELECT CLIENTES.CEDULA, CLIENTES.NOMBRES, CLIENTES.APELLIDOS, FACTURAS.PENDIENTE_DE_PAGO FROM FACTURAS JOIN RESERVAS ON FACTURAS.RESERVA =RESERVAS.ID_RESERVAS JOIN CLIENTES ON RESERVAS.CLIENTE = CLIENTES.ID_CLIENTE
