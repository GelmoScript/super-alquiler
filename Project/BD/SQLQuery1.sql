...
@ESTATUS NVARCHAR(13)
AS
IF(EXISTS @FECHA_INICIO BETWEEN )
INSERT INTO RESERVAS VALUES (@VEHICULO,@CLIENTE,@FECHA_INICIO,@FECHA_FIN,@MONTO_A_PAGAR) 
UPDATE VEHICULOS SET ESTATUS=@ESTATUS WHERE ID_VEHICULO=@VEHICULO
...
EXEC SP_INSERTAR_RESERVA 1,1,'2021-04-10','2021-05-10',5000,'HABILITADO'
