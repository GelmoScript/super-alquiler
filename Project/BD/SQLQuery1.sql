--USANDO LA BD
USE GelmoDatabase
select ID_VEHICULO, MARCA, MODELO, YEARS, COLOR from VEHICULOS WHERE YEARS BETWEEN 2020 AND 2021
...
SELECT CEDULA,NOMBRES,APELLIDOS,PENDIENTE_DE_PAGO/*CLIENTES.CEDULA, CLIENTES.NOMBRES, CLIENTES.APELLIDOS, FACTURAS.PENDIENTE_DE_PAGO*/ FROM FACTURAS JOIN RESERVAS ON FACTURAS.RESERVA =RESERVAS.ID_RESERVAS JOIN CLIENTES ON RESERVAS.CLIENTE = CLIENTES.ID_CLIENTE
...
@BORRADO BIT = 0
AS
INSERT INTO VEHICULOS VALUES (@MARCA,@MODELO,@YEARS,@COLOR,@PRECIO_POR_DIA,@TIPO,@CAPACIDAD_DE_CARGA,@PASAJEROS,@MATRICULA,@NUMERO_DE_SEGURO/*,@FOTO*/,@LATITUD,@LONGITUD,@ESTATUS,@BORRADO)
...
--@BORRADO BIT
AS
UPDATE VEHICULOS SET MARCA=@MARCA,MODELO=@MODELO,YEARS=@YEARS,COLOR=@COLOR,PRECIO_POR_DIA=@PRECIO_POR_DIA,TIPO=@TIPO,CAPACIDAD_DE_CARGA=@CAPACIDAD_DE_CARGA,PASAJEROS=@PASAJEROS,MATRICULA=@MATRICULA,NUMERO_DE_SEGURO=@NUMERO_DE_SEGURO/*,FOTO=@FOTO*/,LATITUD=@LATITUD,LONGITUD=@LONGITUD/*,ESTATUS=@ESTATUS, BORRADO=@BORRADO*/ WHERE ID_VEHICULO=@ID_VEHICULO
...
EXEC SP_INSERTAR_VEHICULO 'HIYUNDAI','SONATA',1977,'AMRILLO',1283,'CAMIONETA',55478,4,'4655312','56451351','56465453','51512312',1
EXEC SP_INSERTAR_VEHICULO 'HONDA','ACCORD',2000,'ROJO',2500,'CAMIONETA',1000,4,'454561','4565153','521531321','51512312',1
EXEC SP_MODIFICAR_VEHICULOS 1,'TOYOTA','COROLA',1977,'AMRILLO',1283,'CAMIONETA',55478,4,'4655312','56465453','521531321','51512312',1
EXEC SP_ELIMINAR_VEHICULOS 1
EXEC SP_INSERTAR_CLIENTES '40225359641','LUIS ALFREDO','PASCUAL POLANCO','LUISALFREDO.LAPP.LAPP@GMAIL.COM','SI','DOMINICANO','B+'
EXEC SP_INSERTAR_CLIENTES '64545645646','CARLOS JAVIER','PASCUAL POLANCO','CARLOSP@GMAIL.COM','SI','DOMINICANO','A+',1
EXEC SP_MODIFICAR_CLIENTES 1,'40225359641','LUIS ALFREDO','PASCUAL POLANCO','LUISALFREDO.LAPP.LAPP@GMAIL.COM','SI','DOMINICANO','B+'
EXEC SP_ELIMINAR_CLIENTE 1
EXEC SP_INSERTAR_RESERVA 1,1,'2021-08-10','2021-09-10'
EXEC SP_INSERTAR_RESERVA 2,2,'2021-10-23','2021-12-10'
EXEC SP_INSERTAR_RESERVA 2,2,'2021-03-23','2021-05-10'
